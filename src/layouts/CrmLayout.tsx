...
const Icons = {
  ...
  propiedades: <City size={20} weight="duotone" />,
  pipeline: <Handshake size={20} weight="duotone" />,
  ...
  finanzas: <CurrencyCircleDollar size={20} weight="duotone" />,
  ...
  contenido: <FilmReel size={20} weight="duotone" />,
  usuarios: <UserList size={18} weight="duotone" />,
  roles: <Lock size={18} weight="duotone" />,
  mensajeria: <Mailbox size={20} weight="duotone" />,
  ...
  clicConnect: <Plugs size={20} weight="duotone" />,
...
export default function CrmLayout() {
  ...
  const marketingSubItems = [
    { id: 'marketing', path: 'marketing/centro', label: 'Centro', icon: Icons.centro },
